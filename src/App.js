...
import WebViewDetails from './containers/WebViewDetails';

//侧滑菜单的页面
import Wallet from "./containers/Wallet";
import CardCoupons from "./containers/CardCoupons";
...
const Tab = TabNavigator({
    ...
    Home: {
        ...
        navigationOptions: {
            ...
            headerStyle: {backgroundColor: '#4398ff'},//导航栏的样式
...
export default Drawer = DrawerNavigator({
    ...
    //     inactiveTintColor: '#4398ff',  // 未选中文字颜色
